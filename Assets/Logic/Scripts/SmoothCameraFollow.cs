...
namespace mercenary_guild
{
    ...
    public class SmoothCameraFollow : MonoBehaviour
    {
        ...
        [Tooltip("If > 0, camera wonâ€™t move while the target stays within this radius from the camera center (in world units).")]
...
#pragma warning restore 0414
        ...
        void UpdatePhotoMode(float dt, bool buildMenuBlockingInput)
        {
            ...
            HandleZoomInput(_photoModeVelocity.magnitude);
        ...
        void HandleZoomInput(float referenceSpeed)
        {/*
