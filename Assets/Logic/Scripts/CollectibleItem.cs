...
/// </summary>
public enum CollectibleItemRarity
    {
    Common,
    Uncommon,
    Rare,
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "CollectibleItem", menuName = "Items/Collectible Item")]
[MovedFrom(true, null, null, "CollectibleItem")]
public class CollectibleItem : ScriptableObject
{
    ...
    private CollectibleType collectibleType = CollectibleType.Weapon;
    ...
    private CollectibleItemRarity rarity = CollectibleItemRarity.Common;
    ...
    /// </summary>
    public CollectibleItemRarity Rarity => rarity;
    ...
    /// </summary>
    public static Color GetColorForRarity(CollectibleItemRarity gearRarity)
    {
        switch (gearRarity)
        {
            case CollectibleItemRarity.Uncommon:
                return new Color32(30, 171, 0, 255);
            case CollectibleItemRarity.Rare:
                return new Color32(0, 112, 221, 255);
            case CollectibleItemRarity.Epic:
                return new Color32(163, 53, 238, 255);
            case CollectibleItemRarity.Legendary:
    ...
    /// </summary>
    public static float GetDropWeightForRarity(CollectibleItemRarity rarityLevel)
    {
        switch (rarityLevel)
        {
            case CollectibleItemRarity.Common:    return 1.0f;
            case CollectibleItemRarity.Uncommon:  return 0.65f;
            case CollectibleItemRarity.Rare:      return 0.35f;
            case CollectibleItemRarity.Epic:      return 0.18f;
            case CollectibleItemRarity.Legendary: return 0.08f;
            default:                   return 1.0f;
        }
    }
    ...
    /*
#if UNITY_EDITOR
[CustomEditor(typeof(CollectibleItemRarity))]
